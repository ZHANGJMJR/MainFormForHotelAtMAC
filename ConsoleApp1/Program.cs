...
// string sql = @"SELECT gch.guestCheckID, gch.openBusinessDate as busDate, gch.locationID, gch.revenuecenterid,
...
//         // 加密 SQL
//         string encryptedSql = SqlEncryptor.EncryptSql(sql);
//         Console.WriteLine("🔐 加密后：" + encryptedSql);
...
//          string encryptedSql = SqlEncryptor.EncryptSql(detailQuerySumRow);
//         Console.WriteLine("🔐 加密后：" + encryptedSql);
...
//     string decryptedSql = SqlEncryptor.DecryptSql(masterQueryE);
//        Console.WriteLine("🔓 解密后：" + decryptedSql);
...
//      string decryptedSql = SqlEncryptor.DecryptSql(detailQueryE);
//         Console.WriteLine("🔓 解密后：" + decryptedSql);
